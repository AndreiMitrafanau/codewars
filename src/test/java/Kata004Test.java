...
public class Kata004Test {
    ...
    public void test1() {
        ...
        assertFuzzyEquals(Kata004.mean("London", Kata004Test.data), 51.199999999999996);
        assertFuzzyEquals(Kata004.mean("Beijing", Kata004Test.data), 52.416666666666664);
    }

    @Test
    public void test2() {
        System.out.println("Fixed Tests: variance data");
        assertFuzzyEquals(Kata004.variance("London", Kata004Test.data), 57.42833333333374);
        assertFuzzyEquals(Kata004.variance("Beijing", Kata004Test.data), 4808.37138888889);
    }

    @Test
    public void regexpWork() {
        List<Double> actual = Kata004.extract("London", data);
        List<Double> expected = Arrays.asList(
                48.0d, 38.9d, 39.9d, 42.2d, 47.3d, 52.1d, 59.5d, 57.2d, 55.4d, 62.0d, 59.0d, 52.9d);
