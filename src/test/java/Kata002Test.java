...
public class Kata002Test {
    ...
    public void shouldWorkWithNoMoves() {
        String[] solution = new String[]{};
         assertEquals(solution, Kata002.streetFighterSelection(fighters, new int[]{0, 0}, new String[]{}));
    }
    ...
    public void shouldWorkWithFewMoves() {
        ...
        assertEquals(solution, Kata002.streetFighterSelection(fighters, new int[]{0, 0}, moves));
    }
